...
else if ('productCategory' in message && !!message.productCategory) {
    const interactiveMessage = {
         nativeFlowMessage: {
              messageParamsJson: JSON.stringify(message.productCategory),
              buttons: message.productCategory.interactiveButtons || [{}]
          }
    }
